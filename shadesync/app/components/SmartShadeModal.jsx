...
export default function SmartShadeModal({ open, onClose }) {
    if (!open) return null;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
            <div className="w-full max-w-md rounded-3xl bg-white/95 px-8 py-7 text-center shadow-[0_20px_60px_rgba(15,28,46,0.35)]">
                <h2 className="mb-3 text-2xl font-semibold text-slate-900">
                    SmartShade is a Premium Feature
                </h2>
                <p className="mb-6 text-sm text-slate-600">
                    In order to access SmartShade, you must upgrade your plan for the low
                    cost of $69/month. Go to your account settings for more information.
                </p>
